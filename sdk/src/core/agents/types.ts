...
// Agent service interface (without Context.GenericTag - that's in service.ts)
...
// Agent manager service interface (without Context.GenericTag - that's in manager.ts)
